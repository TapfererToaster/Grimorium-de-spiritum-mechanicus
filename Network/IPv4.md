...
Devices typically acquire IPv4 address configuration using the *[[(DHCP) Dynamic Host Configuration Protocol]], sending a broadcast on the local network to a DHCP server.
